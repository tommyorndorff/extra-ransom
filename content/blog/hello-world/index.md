...
OK, thats refreshing.  Now, to find a Gatsby deployment process for github 
...
```
No idea how a github action works.  Looks like `yaml`, in a `./.github/workflows/main.yml` file.
